...
namespace Jigsaw;
public class UnstuckComponent : EntityComponent<JigsawPawn>
{
	...
	public virtual bool TestAndFix()
	{
		...
		if ( Entity is JigsawPawn player )
		{
	...
	*/
	...
	{
		if ( Entity is JigsawPawn ply )
		{
			if ( ply.MovementController is MovementController walk )
			{
				return TraceBBox( start, end, walk.mins, walk.maxs, liftFeet );
			}
		}
		return TraceBBox( start, end, Entity.CollisionBounds.Mins, Entity.CollisionBounds.Maxs, liftFeet );
	}
